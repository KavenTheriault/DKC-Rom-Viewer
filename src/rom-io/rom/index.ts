...
export const readRomFile = async (buffer: Uint8Array): Promise<Rom> => {
  try {
    const romData: Uint8Array = getRomData(buffer);
...
export const getRomData = (bytes: Uint8Array): Uint8Array => {
...
const hasHeader = (bytes: Uint8Array): boolean => {
